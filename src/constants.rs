use crate::error_response::error_responses::{
    ...
    ERROR_WRONG_LAST_NAME_STATUS, ERROR_WRONG_REQUEST_STATUS, UNAUTHORIZED_JSON, UNKNOWN_JSON,
    WEAK_LOGIN_JSON, WEAK_PASSWORD_JSON, WRONG_FIRST_NAME_JSON, WRONG_LAST_NAME_JSON,
    WRONG_REQUEST_JSON,
};
...
pub const ALREADY_REGISTERED_EMAIL: (Status, Json<ErrorResponse>) = (
    ERROR_ALREADY_REGISTERED_STATUS,
