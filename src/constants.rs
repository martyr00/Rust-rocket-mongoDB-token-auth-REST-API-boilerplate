use crate::error_response::error_responses::{
    ...
    ERROR_ALREADY_REGISTERED_STATUS, ERROR_UNAUTHORIZED_STATUS, ERROR_UNKNOWN_STATUS,
    ...
    UNAUTHORIZED_JSON, UNKNOWN_JSON, WEAK_LOGIN_JSON, WEAK_PASSWORD_JSON, WRONG_FIRST_NAME_JSON,
    WRONG_LAST_NAME_JSON, WRONG_MAIL_JSON, WRONG_REQUEST_JSON,
};
use rocket::http::Status;
use rocket::serde::json::Json;

pub const EXPIRATION_REFRESH_TOKEN: i64 = 3600; //3600 sec == 1 hour
pub const EXPIRATION_TOKEN: i64 = 25200; //(3600sec * 7) == 7 hour == 25200
